...
argument-hint: <template-path> [--apply]
---

Apply audit-report findings to a template (Stream C work). Follow `CLAUDE.md`. Without `--apply` you produce the corrected draft plus a findings map; with `--apply` you write the corrected file in place.
