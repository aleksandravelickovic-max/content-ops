---
sku: 8x9-hex-red-clay
material: cotto
url: https://ziatile.com/products/8x9-hex-red-clay-cotto-tile
title_tag: 8x9 Hex + Red Clay Terracotta Tile | Zia Tile
meta_description: Shop Zia's 8x9 Hex + Red Clay Cotto. A red hexagon terra cotta tile for kitchen floors, outdoor patios, and bathroom wall installations.
...
Zia's Red Clay 8x9 Hex is a handmade terra cotta tile in an elongated hexagonal format. The palette is a grounded spectrum of deep red, and the hexagonal geometry produces a continuous, non-repeating field where each tile carries its own tonal expression.
...
Cotto is a handmade, unglazed terra cotta tile made from high-fired clay, produced in San Miguel de Allende, Mexico. The surface is left raw from the kiln — no glaze is applied — which preserves the visible tonal movement, matte texture, and inherent variation in tone, shape, edge profile, and thickness that define the material. These characteristics reflect the production method rather than manufacturing inconsistency.

### What are the characteristics of the 8x9 Hex \+ Red Clay?

The 8x9 Hex \+ Red Clay is a hexagon terra cotta tile with a palette that moves between deep red tones across the installation. Each tile measures approximately 8" × 9" in a hexagonal geometry, designed for durable floor and wall installations. The unglazed surface produces natural variation in tone, shape, edge profile, and thickness, characteristics inherent to handmade Cotto.

### Is the 8x9 Hex \+ Red Clay suitable for floors and wet areas?

Yes. The 8x9 Hex \+ Red Clay is suited to flooring in both residential and commercial environments. The dense, high-fired clay body supports high-traffic use while maintaining surface character over time. The unglazed surface has a DCOF of 0.98, well above the slip-resistance threshold for level interior floors. For wet floor applications, increase grout joints to a minimum of ⅛" and consider an anti-slip treatment after installation. Sealing is required; refer to the [Cotto Installation Guide](https://ziatile.com/pages/cotto-installation-guide) for instructions.

### Can the 8x9 Hex \+ Red Clay be used outdoors in freeze/thaw climates?

Yes. The 8x9 Hex \+ Red Clay is suited to exterior installations in any climate, including freeze/thaw regions. For exterior applications, apply a second coat of the pre-grout sealer in place of a matte wax top coat, as UV exposure causes wax to discolor over time. Full exterior sealing instructions are in the [Cotto Installation Guide](https://ziatile.com/pages/cotto-installation-guide).

### Does the 8x9 Hex \+ Red Clay require sealing?

Yes. All Cotto tiles require a two-stage sealing sequence. Before grouting, apply a pre-grout sealer until the tile is fully saturated, then allow it to cure. After the grout has cured, apply a matte wax top coat for interior installations or a second coat of the pre-grout sealer for exterior applications. Full sealing instructions are in the Cotto Installation Guide.

### Can the 8x9 Hex \+ Red Clay be mixed with other Cotto colorways?

Yes. The 8x9 Hex \+ Red Clay can be combined with other Cotto colorways in the same installation. Each colorway is produced from the same clay body and shares consistent thickness and surface character across the range. The deep red palette pairs naturally with the Adobe and Fired Earth tones of the classic range, or creates effective contrast alongside the unexpected tones of Blanco, Madera, and Oscura. Contact [info@ziatile.com](mailto:info@ziatile.com) or 310-844-1170 with questions about mixing colorways.
