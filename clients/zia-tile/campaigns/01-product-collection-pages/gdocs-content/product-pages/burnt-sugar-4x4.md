---
title: "Burnt Sugar 4x4"
google_doc_id: "1faQKEg4SAcYzLxX10ZwVflm3DdaGMjdN4tGE7AUkwMU"
page_type: product
...
**Meta title**: Burnt Sugar 4x4 Square Zellige | Zia Tile
**Meta description**: Shop Zia's Burnt Sugar 4x4 zellige. These handcrafted Moroccan clay tiles feature inherent variation for kitchens, showers, floors, and fireplace features.
...
Zia's Burnt Sugar zellige is the result of a centuries-old Moroccan tradition still practiced today by skilled artisans. The same techniques once used to compose the decorative geometric and floral mosaics of grand palaces and riads now produce this warm brown 4x4, scaled for kitchens, bathrooms, and commercial interiors. From hand-shaped clay to glaze applied by hand, each tile carries the small irregularities that come from being made one at a time.
...
Our Burnt Sugar 4x4 zellige offers a versatile square format suited to residential and commercial projects alike. These square tiles are often installed as a kitchen backsplash, bathroom wall, shower tile, or fireplace feature.

### Residential Usage

  - **Interior Floors – High Traffic:** Burnt Sugar 4x4s perform well across high-traffic areas, including kitchens and entryways.
  - **Interior Floors – Low Traffic:** A reliable choice for low-traffic settings such as guest bathrooms, powder rooms, and walk-in closets.
...
### Commercial Usage
  ...
  - **Interior Floors – High Traffic:** Burnt Sugar 4x4s perform well across high-traffic commercial settings, such as restaurant kitchens, hotel lobbies, and entryways. If installed on a flooring surface in a wet area, **slip resistance** can be increased by sizing grout joints to a minimum of 1/8" and/or applying an **anti-slip treatment** after installation is complete.
  - **Interior Floors – Low Traffic:** This square format performs well across lower-traffic commercial interiors such as restrooms and private spaces.
  - **Exterior Floors – Freeze or Thaw:** Burnt Sugar zellige is not suitable for outdoor installation in a freeze/thaw climate.
...
Each Burnt Sugar 4x4 is made by Moroccan artisans whose technique has been passed down across generations, producing tiles with both lasting quality and innate variation.



The process begins with raw clay drawn from local Moroccan hillsides. Artisans soak the clay in water and filter it for impurities until the material becomes soft and workable, then press it into molds and set it out under the Moroccan sun to dry. Once the clay has firmed up, each tile is flattened and refined by hand.



The tiles are dipped individually in glaze and placed into an earthen kiln, where heat moves unevenly through the chamber. That uneven distribution is what produces the warm tonal range and dynamic glazes specific to the collection.
...
### Sample Orders
  ...
  - Our in-stock Burnt Sugar zellige 4x4 samples typically ship from our Los Angeles warehouse within two business days of order receipt.
  - Select the "Add Sample to Cart" button to add a Burnt Sugar 4x4 sample to your cart.
...
Clean Burnt Sugar zellige with a pH-neutral cleaner such as Miracle Sealants pH Neutral Tile and Stone Cleaner and warm water for routine maintenance. Avoid acidic cleaners, bleach, or abrasive tools, all of which can damage the glaze. Vacuum or sweep the surface regularly to clear away abrasive debris that could otherwise scratch the tile over time.

### Does each Burnt Sugar tile arrive with a consistent thickness?

No, each Burnt Sugar 4x4 is shaped by hand, which produces variation in thickness, shape, and color across the collection. These differences are part of what gives a zellige installation its organic surface and distinguishes it from machine-cut tile.
...
Zellige tile edges are typically finished using mitered edges or Schluter strips. Both options create a clean transition at the edge of an installation while respecting the tile's handcrafted nature. Edge finishing should be planned with your installer before work begins to ensure a cohesive result.
