---
title: "Skylight 4x4 Square Zellige"
google_doc_id: "1XkORPwE1gZbGF7cfVWNpmeVeQl_OOJvidtlK94JZwro"
page_type: product
...
**Title Tag:** Skylight 4x4 Square Zellige | Zia Tile

**Meta Description:** Shop Zia's Skylight 4x4 zellige. A sky-blue handcrafted Moroccan tile suited for kitchen backsplashes, bathroom walls, and shower installations.

**Keywords:** Skylight 4x4, Blue zellige tile, sky-blue zellige
...
Our Skylight zellige is a handcrafted Moroccan tile suited to both residential and commercial projects. At 4x4 inches, the square format works well on kitchen backsplashes, bathroom walls, and shower enclosures, where the soft sky-blue tones and inherent variation are experienced up close.
...
The clay that becomes each Skylight 4x4 is pulled from the hillsides surrounding Fez, Morocco. Artisans soak it in water, filter it for impurities, and work it by hand until it reaches the right consistency for pressing into molds. The shaping is done entirely by hand, which is why no two tiles sit at exactly the same depth or carry the same edge.

After drying in the Moroccan sun, each tile is dipped individually in glaze. The Skylight glaze is where the sky-blue tones take form. Because each dip is done by hand, the coverage varies from tile to tile, and that variation is what produces the tonal range visible across a full installation.

The final stage is the kiln. Earthen kilns do not distribute heat evenly, and the results of that unevenness are not incidental. The chips, pits, crazing, and shifting tones that emerge from the firing process are what make each Skylight 4x4 its own.

## Order & Shipping

### Sample Orders

  - Our in-stock Skylight zellige 4x4 samples typically ship from our Los Angeles warehouse within two business days of order receipt.
  - Select the "Add Sample to Cart" button to add the Skylight 4x4 to your cart.
...
### Can I mix Skylight 4x4 zellige with other formats in the collection?

Yes, you can mix Skylight 4x4 with other formats in Zia's zellige collection. Each format is produced using the same traditional methods, so tiles share a consistent surface character across the range. Mixing square and rectangular formats is a common approach for larger wall compositions and backsplashes, provided tiles are blended from multiple boxes during the dry layout stage.

### What colors complement Skylight zellige?

Skylight zellige pairs well with both warm and cool palettes due to its soft blue-grey tone. Neutral materials such as cream, sand, and warm white create a restrained backdrop, while deeper tones like navy, charcoal, or emerald introduce bold contrast. Unlacquered brass and matte black fixtures tend to balance the cool hues of the glaze and reinforce its tonal depth.

### Does Skylight zellige work in a small kitchen?

Yes, Skylight zellige works well in a small kitchen. The glazed surface reflects light, which helps a compact space feel more open, and the soft sky-blue tones read well against both natural and artificial light. Used as a kitchen backsplash, the variation in tone and surface adds depth without overwhelming the room.

### How does Skylight zellige look paired with wooden flooring?

Skylight zellige pairs well with wooden flooring. The contrast between the cool glazed surface of the tile and the warm texture of natural wood creates a grounded composition. This pairing is common in interiors that rely on natural material contrasts.

### What design styles suit Skylight zellige?

Skylight zellige suits a wide range of design styles due to its neutral palette and handcrafted variation. The tile works in modern minimalist interiors where subtle surface character is part of the design direction, as well as in Mediterranean and traditional settings where the handcrafted nature of zellige is foregrounded.

### Can I mix Skylight zellige with other colors in the collection?

Yes, you can mix Skylight zellige 4x4 with other colors in Zia's zellige collection. Each colorway is produced using the same traditional methods, so tiles share consistent thickness, format, and surface character across the range. Skylight pairs particularly well with warm neutrals and deeper cool tones in the collection, where the contrast creates a layered, considered composition.
