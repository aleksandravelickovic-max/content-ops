---
title: "Zellige Glazed Earth 2x6"
google_doc_id: "1dfhNT39qcmxZLRmMSVzjtmGtKiE97WD2oSGHstQcPUo"
page_type: product
...
Zia's Glazed Earth 2x6 is a traditional zellige produced in Morocco using methods refined over centuries. Artisans historically installed these tiles in mosaics featuring decorative geometric and floral shapes within elaborately designed palaces. The Glazed Earth colorway moves across a wide beige range from tile to tile. The 2x6 Bejmat format suits stacked, running bond, and herringbone layouts across both residential and commercial installations.
...
Working with zellige takes more time than standard ceramic tile because each piece varies in thickness, edge, and size. Budget two to three times the installation window of a precision-cut tile, and use wedge spacers to maintain consistent spacing and protect edges across the surface.
...
Zia's Glazed Earth 2x6 zellige offers a long, narrow format suited for residential and commercial projects. Designers often install these handcrafted tiles as a kitchen backsplash, bathroom wall, shower tile, or fireplace feature.
...
Zia's Glazed Earth 2x6 zellige tiles are handmade by Moroccan artisans using traditional production methods refined over centuries.



Artisans begin with raw clay sourced from local hillsides, which is soaked and filtered to remove impurities. The clay is hand-pressed into rectangular molds and shaped by hand into the 2x6 Bejmat format before being set to dry in the Moroccan sun.



Once dry, each tile is hand-dipped individually in glaze. The beige glaze settles differently on each tile at the dipping stage, producing the wide tonal range that makes Glazed Earth move across shades of beige from tile to tile. The tiles are then placed in earthen kilns where heat distributes unevenly, producing the chips, pits, crazing, and tonal shifts that make each Glazed Earth 2x6 perfectly imperfect and entirely its own.
...
### Sample Orders
  ...
  - Our in-stock Glazed Earth 2x6 zellige samples typically ship from our Los Angeles warehouse within two business days of order receipt.
  - Select the "Add Sample to Cart" button to add the Glazed Earth 2x6 to your cart.
...
### Full Orders
  ...
  - All standard full orders ship throughout the US and Canada via LTL carrier service with curbside pallet delivery.
...
### Can I install Glazed Earth 2x6 zellige in a vertical layout?

Yes, you can install Glazed Earth 2x6 zellige in a vertical layout. Vertical stacking emphasizes the elongated Bejmat format and changes how variation in color, thickness, and surface reads across the installation.

### Does the 2x6 Bejmat format require a specific layout pattern?

No, the 2x6 Bejmat format does not require a specific layout pattern. Common layouts include straight stack and herringbone, and each distributes variation in chips, pits, and crazing differently across the surface.

### Can I use Glazed Earth 2x6 zellige for a full-height wall installation?
...
### Can I adjust tile placement during installation to balance variation?

Yes, you can adjust Glazed Earth 2x6 tiles during installation to balance variation. Installers often reposition tiles to distribute differences in tone, thickness, and surface, including chips, pits, and crazing.

### Can I combine Glazed Earth 2x6 with other zellige formats?

Yes, you can combine Glazed Earth 2x6 with other zellige formats. Maintaining consistent spacing and planning transitions between formats helps create a cohesive installation.
