---
title: "Absinthe Trapezoid - Product Page"
google_doc_id: "1UZ7nEnMwWnPvnBVixfhebdfpLdAVOE7XJucUPvIklqQ"
page_type: product
...
**Title Tag:** Absinthe Trapezoid Zellige | Zia Tile

**Meta Description:** Shop Zia's Absinthe Trapezoid zellige. An aqua-hued handcrafted Moroccan tile for kitchen backsplashes, bathroom walls, and shower installations.
...
Our Absinthe Trapezoid zellige brings its aqua-hued glaze and geometric format to kitchen backsplashes, bathroom walls, shower tile, and pool installations across both residential and commercial settings. The trapezoid geometry introduces directional movement across floor and wall applications alike, making it particularly effective where pattern and surface variation are part of the design intent.
...
Our Absinthe Trapezoid reflects the working traditions of Fez, Morocco, where handcrafted zellige production stays true to artisanal practices refined over centuries. Artisans begin with raw clay pulled from local hillsides, soaking and filtering it to remove impurities before pressing it into molds. The trapezoid geometry is established at this stage, where each piece is hand-shaped into its final angular form rather than extruded or mechanically cut.

  

Once partially dried under the Moroccan sun, each tile is hand-dipped in an aqua-hued glaze. The semi-transparent application is what allows the clay body underneath to influence the final tone, producing a layered surface rather than a flat color. Because the glaze is applied by hand, coverage varies tile to tile, and that variation is what creates the range between soft mint and deeper water-toned greens visible across a full installation.

  

The final stage is the kiln. Tiles are fired in earthen kilns where heat moves unevenly through the chamber. This firing process is what produces the dynamic tonal shifts, along with the chips, pits, and crazing that appear as part of the surface rather than as a condition to be corrected. Each Absinthe Trapezoid records the conditions of its making.
...
### Sample Orders
  ...
  - Our in-stock Absinthe Trapezoid zellige samples typically ship from our Los Angeles warehouse within two business days of order receipt.
  - Select the "Add Sample to Cart" button to add the Absinthe Trapezoid to your cart.
...
### What are the characteristics of Absinthe zellige tiles?

The characteristics of Absinthe zellige include high inherent variation in color, shape, and thickness, along with chips, pits, and crazing as natural surface characteristics. Zia's Absinthe Trapezoid presents an aqua-hued range that shifts from soft, translucent tones to deeper, water-toned hues depending on light and placement. Each tile is hand-shaped and glazed, resulting in irregular edges and a reflective surface that defines the trapezoid format across the installation.

### Can I use the Absinthe Trapezoid in the kitchen? 

Yes, Absinthe Trapezoid can be used in a kitchen, particularly as a backsplash where the glazed surface responds well to moisture and routine cleaning. The trapezoid format introduces directional movement across the wall, which allows for custom layouts that extend beyond standard grid installations. As with all zellige, installation requires careful placement to manage variation and maintain a consistent composition across the full surface.
...
Floors that go with the Absinthe Zellige tile typically fall within natural or matte material categories. Wood flooring in oak or walnut tones complements the green glaze by introducing warmth and texture. Stone surfaces, such as limestone or travertine, provide a neutral counterpoint that allows the wall installation to remain the focal point. Concrete floors offer a more restrained backdrop, balancing the reflective quality of the zellige surface.

### Can I mix Absinthe Trapezoid with other zellige colors?

Yes, you can mix Absinthe Trapezoid with other colors in Zia's zellige collection. Each colorway is produced using the same traditional methods, so tiles share consistent surface character across the range. The aqua-hued palette works particularly well alongside warm neutrals, creams, and deeper greens, where the glaze reads as a color-forward accent against a quieter surrounding field.

### How does the trapezoid format install?

The trapezoid format installs as a geometric composition where the angled edges of each tile interlock to form directional patterns across the field. The shape supports a range of layouts, from staggered chevron-like arrangements to more complex tessellations, and the specific pattern should be determined during the dry layout stage. Because the geometry depends on consistent orientation, a full dry run before setting is essential to confirm how the pattern resolves across the full floor or wall.
