...
A square tile is any tile whose length and width are equal. The format has been crafted in ceramic, zellige, stone, cement, and glass mosaic production for centuries and covers a wide range of sizes, from small square tiles at 2x2 to large-format 24x24 field tiles. Each material produces a distinct color, finish, and design result at the same square dimension.
...
A small square tile at or below 2x2 inches is called a square mosaic tile. When the individual units are hand-cut stone, the traditional term is tesserae, from the Latin word for the small square pieces used in Roman and Byzantine mosaic work. Zia's Roman Mosaic collection uses Italian marble hand-cut into 5/8-inch tesserae squares by artisans in Italy, backed on mesh sheets for installation. Zellige solids and checkerboards are also available in 2x2-inch squares, and the newest collection offers 1x1-inch recycled glass mosaics.
