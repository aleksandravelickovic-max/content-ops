---
title: "Cotto - Core Collection Page"
google_doc_id: "10K_Kt9IVBMU5ehTnzUp7Iq_IGtCSmKVhxSXM9Wa4OvQ"
...
**Meta title**: Handmade Terra Cotta Tile | Zia Tile  
**Meta description**: Handmade in Mexico, Zia's Cotto is an unglazed terra cotta tile suitable for floors, walls, and outdoor installations in any climate.
...
Cotto comes in six core colorways: three traditional terra cotta hues and three unexpected tones. The classic range carries the warm palette that has defined terra cotta for centuries:
...
Standard squares (4x4, 8x8, 13x13) and rectangles (2x6, 6.5x13) anchor the line, alongside an 8x9 hexagon and a set of signature shapes drawn from Spanish-colonial and Mesoamerican design traditions:

  - Stars & Cross, an eight-pointed star paired with a cross, the two shapes interlocking into a Moorish pattern
  - Alcazar (6x6) and Big Alcazar (13x13), geometric interlocking shapes named for the alcazar, the Spanish-Moorish fortress
  - Oaxaca, an hourglass form paired with rounded octagons
  - Durango, a four-tile set that builds an abstract geometric pattern
  - Tornillo, long, narrow parallelograms set in a staggered, overlapping layout
  - Toltec, named for the pre-Aztec Mesoamerican civilization centered at Tula
  - Zocalo, two asymmetrical pieces that come together to create a bold rectangular design
...
For deeper cleaning:
  ...
  - Use warm water with a pH-neutral cleaner, such as Miracle Sealants Tile and Stone Cleaner. Apply with a soft cloth or mop and rinse thoroughly
  - Avoid abrasive tools or pads, which can wear the sealed surface and reduce its protective layer
  - For stubborn marks, use a gentle cleaner such as Miracle Heavy Duty Cleaner (Acid Substitute)

### How do I install Cotto tile?

Installing Cotto tile requires a professional installer experienced with terra cotta, specifically. The process requires an eye for balancing tile variation and protecting the porous surface. Each of our tiles has its own [installation guide](https://ziatile.com/pages/cotto-installation-guide), and for project-specific installation questions, the Zia team is available at info@ziatile.com or 310-844-1170.
...
Calculating how much Cotto tile is needed for an installation starts with the total square footage of the surface. Measure the length and width of each surface area in feet, then multiply them together for the surface area. For walls or multi-surface floors, add all sections together to reach the total square footage. From that total, add a minimum of 15 to 20% overage to account for curation and cuts. For a more uniform look or for specialty shape formats like the Durango, plan for 20 to 25% across the full order, given the nuance of the multi-tile pattern. For project-specific quantity questions, contact the Zia team at info@ziatile.com or 310-844-1170.
