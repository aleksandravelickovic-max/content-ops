...
A large format tile is any tile with at least one edge measuring 12 inches or longer, though the term is most commonly applied to formats starting at 12x24 and scaling up to 24x24 and beyond. At Zia, large format tiles are available in terrazzo, cotto, cantera, marble, and limestone, in formats including 12x12, 12x24, and 24x24, as well as specialty shapes like the Durango format.
