...
Red tile at Zia ranges from clay-based terracotta to deeper burgundy tones across cotto, glazed Cotto Allende, marble, and zellige. The color comes from the material itself and each surface can read differently once installed. Zellige shows variation in tone along with chips, pits, and crazing, while cotto and marble present a more grounded, matte surface. This range supports different applications, from backsplashes to interior floors.
...
### What patterns work best with rectangular red tiles?

Rectangular red tiles are commonly installed in straight stack, running bond, or vertical stack patterns. A running bond softens variation and feels more traditional, while a stacked layout reads more structured and emphasizes the tile shape. With handmade materials like zellige, simpler patterns allow variation in tone, along with chips, pits, and crazing, to carry the surface.
...
Red tile pairs with white, natural wood, and darker tones. Lighter finishes reduce contrast and allow the tile to read more evenly across the surface. Darker finishes increase contrast and define the tile more clearly within the space. Material undertone should guide the pairing.

### What's the best grout color for red tile?

Grout color affects how the tile reads once installed. A close match creates a more continuous surface. A contrasting grout highlights the shape and layout of each tile. Mid-tone grout reduces contrast and softens the overall grid. For zellige, a closer match allows variation in tone to read as a single field.

### What's the difference between red zellige, marble, and terra cotta tile at Zia?
