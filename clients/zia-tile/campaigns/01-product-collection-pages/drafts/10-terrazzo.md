...
For over 500 years, terrazzo has defined iconic design, from historic Italian architecture to the sunlit modernism of Palm Springs. Equally at home in Classic, Mid-Century Modern, and contemporary minimalist interiors, this multifaceted material is available in 12x12 and 24x24 square sizes. 

Authentic terrazzo tiles are crafted by setting a curated blend of natural stone aggregates into a base, then cement is poured, cured, ground, and polished to achieve a smooth and distinctive finish.

\[IMAGE: SIZE/THICKNESS DIAGRAM\]

#### Order Details \+ Installation

We recommend a 15-20% overage on all terrazzo orders to account for any cuts needed. Before installation, blend tiles from all boxes and arrange a layout to evenly disperse aggregate distribution. Use 1/8" tile spacers for the recommended grout joint. Installers will need to slightly adjust grout joint spacing (shim) or use wedge spacers to maintain straight grout lines. Where necessary, tile edges may be trimmed with a wet saw to assist with alignment.

---

## About 

Each terrazzo tile is a cement-based composite with crushed marble and stone aggregates ground and polished to a matte surface. Aggregate distribution varies tile to tile. Blend tiles from all boxes before installation and arrange a layout to disperse aggregate evenly. 

Perhaps the most versatile tile Zia produces, with endless colorways, patterns, and shapes, Zia strives to offer the world’s best curated collection of encaustic terrazzo tiles. While generally consistent in appearance, each handmade tile is inherently unique. Durable and versatile, matte terrazzo tile is an easy choice for many installations.

Installers must wear protective face and eye coverings when working with terrazzo, thinset, sealants, and grout, in accordance with [California Prop 65](https://www.ziatile.com/proposition-65-warnings). Bring drywall flush with the finished surface of the tile, or finish exposed edges with mitered edges or Schluter strips. 

Proper installation and protection of terrazzo tile is key, so please ensure you work with an installer who has experience specifically installing terrazzo tile, and who has carefully reviewed [Zia’s installation guide](https://ziatile.com/pages/terrazzo-installation-guide).

---

## Tile Usage *\[Locked\]* 

*Reference for usage: [https://ziatile.com/products/neutra-12x12](https://ziatile.com/products/neutra-12x12)* 
...
| **Radiant Heating Compatible** *Compatible with all heated floor systems* | **✓** |
| **Sealing Required** *See [install guide](https://ziatile.com/pages/terrazzo-installation-guide) for recommended sealers* | **✓** |

---

## How It's Made 

Terrazzo is produced using techniques refined by Venetian stone masons since the 15th century, when leftover marble offcuts were combined with cement to floor courtyards and palazzo halls. The same craft is preserved in the workshops where Zia's terrazzo is produced today.

Crushed marble and stone aggregates are arranged in steel molds and covered with liquid cement, then hydraulically pressed into a powdered concrete base. Once cured, the surface is ground and polished to the matte finish that defines the line.

Each tile is finished by hand, which produces the subtle tonal variation, occasional crazing, and slight edge irregularity that separate hand-pressed terrazzo from machine-set composite tile. The cement matrix and the visible aggregate are what define terrazzo as a material; the press and the finish are what carry that definition into the floor.
...
**\----- Read this guide, IN FULL, prior to beginning any installation of terrazzo tile \-----**

To ensure proper installation based on unique project and/or site conditions, clients are responsible for hiring a skilled installer that has experience in installing and sealing terrazzo tiles. Zia Tile is not responsible for installation, ongoing care, or issues arising after receipt and installation of product. If client’s installer deviates from the instructions or recommendations below, this may result in costly and undesirable outcomes.
...
* Due to the inherent color variation of terrazzo tile, it is very important to ***blend*** the tiles from ***all*** boxes in your order. You should then lay out all tiles in the installation area to ensure any variation is evenly distributed ***before*** beginning your installation.  
...
* Trowel  
* Mapei Flexcolor CQ, neutral colored grout – avoid spreading dark or contrasting grout over the surface of terrazzo tiles  
* Grout float  
* Grout bag – if using a contrasting grout color  
* Water-cooled tile saw with diamond edge blade

**For cleaning and sealing terrazzo tiles:**
...
* Place in small sections, no larger than 2’x2’, at a time using 1/18” tile spacers to separate the tiles.  
...
* Terrazzo tiles must be sealed on-site. Use a pH neutral cleaner before sealing; products made to clean natural stone are usually suitable. Use of acidic cleaners will damage the tiles and should be avoided.  
...
* We recommend installing terrazzo from floor to ceiling or bringing drywall flush with the finished surface of your tile to eliminate the need for trim.  
...
**Over time, terrazzo tile wears like a natural stone product, which is part of the appeal of this old-world tile. Clients should expect natural wear, fine lines on the tile surface (also known as crazing) and patina to occur to the finish over time.**
...
* terrazzo tiles should be cleaned using pH neutral cleaners ONLY. Use of acidic cleaners will stain the tiles. For regular cleaning, we recommend Miracle Sealants pH Neutral Tile and Stone Cleaner. For heavier stains, we recommend Miracle Sealants Heavy Duty Cleaner (Acid Substitute).

**RE-SEALING**

* terrazzo tile should be re-sealed at least every 1-2 years, or as often as needed depending on traffic and wear. For areas exposed to moisture, you may need to re-seal more often. Always re-seal in accordance with sealant manufacturer’s instructions.
...
Minimum 6 questions covering: aggregate distribution and tonal variation across the line and how to blend across boxes; the difference between the format sizes and where each suits best; shower-floor and wet-area slip resistance with the minimum ⅛" grout joint spec; the two-step sealing protocol and why acidic cleaners must be avoided; and the Venetian origins of the technique and its connection to the current production.