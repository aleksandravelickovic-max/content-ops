...
sku: volcan-12x12
material: cantera
url: https://ziatile.com/products/volcan-12x12
title_tag: Volcan 12x12 Cantera Stone Tile | Zia Tile
meta_description: Shop Zia's Volcan 12x12 Cantera. A warm brown volcanic stone tile cut by hand in Mexico, suited for interior floors, exterior non-freeze/thaw applications, and feature wall installations.
keywords: Volcan 12x12 cantera, Brown cantera stone tile, Volcanic stone floor tile
...
Quarried and cut in Mexico, Zia's Volcan 12x12 is a warm brown cantera stone formed over millions of years from volcanic rock and ash. Cantera has been a primary building material in Mexican and Central American architecture for thousands of years, and the Volcan colorway reflects the warm brown tones found naturally in the volcanic rock formations. At 12x12 inches, the square format produces a continuous floor field where the aggregate distribution and mineral variation of each tile read across a broader surface than smaller mosaic formats — the individual character of each piece contributes to an installation with natural, even movement.
...
Volcan cantera is a warm brown volcanic stone with tonal variation built into the material itself. The color shifts slightly from tile to tile due to the natural variation in the volcanic rock, and each piece carries its own distribution of aggregate, mineral inclusions, and oxidation markings within that warm brown range. The overall installation reads as a unified warm brown field with natural tonal movement.

### Does Volcan 12x12 require sealing?
...
### Can Volcan 12x12 be used outdoors?

Yes, in non-freeze/thaw climates only. Volcan 12x12 is suitable for exterior floor and wall applications in climates that do not experience freeze/thaw conditions. It is not suitable for any outdoor installation in climates that get snow or ice, as freeze/thaw cycling will damage the porous volcanic stone. For exterior applications, seal before and after grouting and apply a second coat of 511 Porous Plus as a top coat rather than wax.
...
### How do I clean Volcan 12x12 cantera?

To clean Volcan 12x12, vacuum or sweep regularly to remove abrasive debris. For routine cleaning, use a pH-neutral cleaner such as Miracle Sealants pH Neutral Tile and Stone Cleaner. For heavier staining, Miracle Sealants Heavy Duty Cleaner (Acid Substitute) is the recommended product. Avoid acidic cleaners — including vinegar, lemon juice, and bleach — and blot spills promptly rather than wiping to prevent spreading.

### Can Volcan 12x12 be mixed with other Volcan formats?

Yes. Volcan 12x12 can be mixed with other Volcan formats — including the 4x12, 12x24, and 24x24 — within the same installation. All formats in Zia's Cantera line are cut from the same volcanic rock source and share consistent material character. Blend tiles from all boxes regardless of format during the layout stage to distribute tonal and aggregate variation evenly, and assess the visual balance across formats during the dry layout before setting.
