---
sku: square-madera-8x8
material: cotto
url: https://ziatile.com/products/8x8-square-madera
title_tag: Madera 8x8 Square Cotto Tile | Zia Tile
meta_description: Shop Zia's Madera 8x8 Square Cotto. A handcrafted Mexican terra cotta tile in a rust-brown palette for kitchen floors, outdoor patios, and feature walls in any climate.
keywords: Madera 8x8 cotto, Rust brown terra cotta tile, Square cotto tile 8x8
...
Zia's Madera 8x8 is a handmade terra cotta tile produced in San Miguel de Allende, Mexico, in the standard 8x8 square format. The Madera colorway reads as rust-brown across the unglazed surface, with tonal movement between deep earth-brown and warm clay tones typical of kiln-fired natural clay. At 8x8 inches, the square format is large enough to read as a defined individual tile while still working across both intimate and expansive floor applications. Cotto (derived from the Italian 'terra cotta', or 'baked earth') is a handmade tile from San Miguel de Allende. The unglazed surface deepens into patina with use, bringing beauty to the material's aging process. Images shown represent a sample of this tile and do not display every potential variation.
...
### What color is Madera cotto?

Madera cotto is a rust-brown unglazed terra cotta with tonal movement between deep earth-brown and warm clay tones across the surface. The color comes entirely from the natural clay body and the kiln-firing process — no glaze modifies the final tone. Individual tiles carry different positions in the rust-brown range, and those differences distribute across the full installation to produce a floor with natural tonal variation rather than uniform color.

### What paint colors go with Madera 8x8 cotto?

Madera cotto pairs best with paint colors that either complement the warm rust-brown palette or provide grounding contrast. Warm off-whites and cream tones keep the surrounding field light and open while letting the earthy rust-brown lead. Muted greens — sage, olive, and soft celadon — align with the earthy tonal range. Deep charcoal, navy, and black introduce stronger contrast and increase the visual weight of the space. Warm plaster finishes in sand and ochre wrap the room in the same earthy register as the tile.

### Can Madera 8x8 cotto be used in a kitchen?

Yes. Madera 8x8 can be used in a kitchen on both floors and walls. The tile performs well in backsplash and flooring applications when properly sealed to protect against moisture and staining. Apply 511 Porous Plus before grouting, then finish with Fila Matte Wax for interior installations. A minimum 1/8" grout joint is recommended for kitchen floor installations.

### How do I seal Madera 8x8 cotto?

To seal Madera 8x8, apply 511 Porous Plus before grouting to saturate the surface and reduce absorption. After grouting and allowing the grout to cure, apply a second coat. For interior applications, finish with Fila Matte Wax as a final protective coat. For exterior applications, apply a second coat of 511 Porous Plus in place of wax — UV exposure causes wax to discolor over time outdoors. Periodic resealing is required to maintain resistance to moisture and staining.

### Can Madera 8x8 cotto be used outdoors in cold climates?

Yes. Madera 8x8 cotto is suitable for exterior floors in freeze/thaw climates. The high-fired clay body is durable enough to handle freeze/thaw cycling when properly sealed. Apply 511 Porous Plus before and after grouting, and use a second coat of 511 Porous Plus as the final top coat for all exterior applications — wax is not appropriate outdoors.

### Can Madera 8x8 be mixed with other Madera cotto formats?

Yes. Madera 8x8 can be mixed with other Madera formats in the Zia Cotto collection — including the Durango specialty shape or the Alcazar format in the same colorway. Each format is produced from the same clay body and firing process, so tiles share consistent surface character and tone across the range. Plan any mixed-format layout during the dry stage before setting begins and blend tiles from all boxes to distribute tonal variation evenly.
