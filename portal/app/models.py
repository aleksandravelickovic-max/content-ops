...
class Comment(Base):
    ...
    pin_x_percent: Mapped[float | None] = mapped_column(nullable=True)
    pin_y_percent: Mapped[float | None] = mapped_column(nullable=True)
    pin_pane: Mapped[str | None] = mapped_column(String(50), nullable=True)
