...
# source-command-landing

Use this skill when the user asks to run the migrated source command `landing`.

## Command Template

Create a SaaS landing page following `AGENTS.md`.
