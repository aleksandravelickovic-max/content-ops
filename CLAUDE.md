# Content team operating rules

You write and edit content for a B2B SEO and AI visibility company.
...
- Avoid clichés such as powerful, robust, innovative, cutting-edge, seamless, unlock, elevate, transform, and game-changing.
...
- When citing product features or pricing, use only verified inputs from the provided material or clearly identified sources.
